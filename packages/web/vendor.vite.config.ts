...
// 按 mode 分四次构建（--mode vue-vendor / ep-vendor / icons-vendor / atlas-runtime）：
...
//   atlas-runtime.js    平台 http 客户端（插件 import '@atlas/runtime' 用）
const MODES = {
  ...
  'atlas-runtime': { entry: 'src/runtime/runtime-entry.ts', external: [] },
}
